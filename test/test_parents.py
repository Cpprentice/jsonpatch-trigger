...
from jsonpath_ops.common import make_jsonpath
from jsonpath_ops.parents import _make_raw_parent, make_parent_key_pairs
...
def test_make_raw_parent():
    ...
    # Important! different forms of writing are unequal if not built using jsonpath_ops.common.make_jsonpath
